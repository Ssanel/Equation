...
disp ('2. Fixed-point iteration');
disp (['Approximate root value: ', num2str(x0)]);
disp (['Number of iterations: ', num2str(k2)]);
...
disp ('3. Newton');
disp (['Approximate root value:', num2str(x03)]);
disp (['Number of iterations: ', num2str(k3)]);
...
disp (['Approximate root value: ', num2str(x0)]);
disp (['Number of iterations: ', num2str(k4)]);
...
disp ('5. Combined');
disp (['Approximate root value: ', num2str(x0)]);
disp (['Number of iterations: ', num2str(k5)]);
